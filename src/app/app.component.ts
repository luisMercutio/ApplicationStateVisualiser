...
import { InstancesComponent } from './components/views/instances/instances.component';
...
@Component({
  ...
  imports: [
    ...
    InstancesComponent, MethodologyEditorComponent,
  ],
  template: `
    <div class="app-shell">
      ...
      <div class="workspace">
        @switch (page()) {
          ...
          @case ('instances') { <app-instances></app-instances> }
