            ...
            <div class="epic-group">
              ...
              <div class="rule-list">
                @for (r of list.rules; track r.creationIndex) {
                  <div class="rule-card">
                    <div class="rc-head">
                      <span class="r-seq">{{ r.executionOrder }}</span>
                      <span class="r-name">{{ r.name }}</span>
                      @if (specs()[r.creationIndex]; as s) {
                      ...
                      <span class="spacer"></span>
                      <button mat-icon-button class="xs edit-btn" [class.has-spec]="specs()[r.creationIndex]"
...
// Numeric executionOrder compare; nulls sort last (mirrors br-list).
