...
// Create or edit a single registered application. Its Epics / Business Rules /
// Notes all live in the one store DB, scoped by this application's id.
@Component({
    ...
    <mat-dialog-content>
      <div class="form-grid">
        ...
        <mat-form-field appearance="outline">
          ...
          <textarea matInput rows="3" [(ngModel)]="description"
                    placeholder="What this application does"></textarea>
        </mat-form-field>

        <mat-form-field appearance="outline">
          <mat-label>Root directory</mat-label>
          <input matInput [(ngModel)]="rootDir" placeholder="e.g. C:\\path\\to\\project" autocomplete="off" />
        </mat-form-field>
      </div>
    </mat-dialog-content>
...
export class ApplicationFormDialogComponent {
  ...
  private buildInput(): ApplicationInput {
    return {
      ...
      rootDir: this.rootDir.trim() || null,
    };
  }
